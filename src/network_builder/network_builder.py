...
try:
    ...
    print("Warning: Visualization dependencies not found. Install with: pip install -r requirements-visualization.txt")
...
class LayerConfig:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'LayerConfig':
        ...
        return cls(
            ...
            input_shape=tuple(data['input_shape']) if 'input_shape' in data and data['input_shape'] else None,
            output_shape=tuple(data['output_shape']) if 'output_shape' in data and data['output_shape'] else None
        )
...
class NetworkBuilder:
    ...
    def visualize(self, filename: Optional[str] = None, format: str = 'png', 
        ...
        if not VISUALIZATION_AVAILABLE:
            print("Visualization dependencies not available. Install with: pip install -r requirements-visualization.txt")
            return
